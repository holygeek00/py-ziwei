...
└── app/
    ...
    └── astro/
        ...
        ├── analyzer.py          # 宫位/星耀分析、三方四正、飞星 (New)
        ├── horoscope.py         # 运限详解、流耀组合 (New)
        └── astro.py             # 排盘主入口
```

## 🔍 高级分析功能

本项目不仅提供基础排盘，还复刻了 iztro 的核心分析能力：

- **三方四正** — 获取指定宫位的对宫、财帛位、官禄位，并进行综合星耀判断
- **飞星/自化** — 根据宫位天干判断四化飞往何处，或是否产生自化
- **星耀查询** — 快速定位任何星耀所在的宫位，查询其对宫及三方四正
- **亮度/四化** — 判断星耀的庙旺利陷，以及是否带有禄权科忌
- **动态流耀** — 实时计算大限、流年等重叠后的星耀分布情况
